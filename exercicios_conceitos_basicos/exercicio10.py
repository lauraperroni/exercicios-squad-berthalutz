...
hobby= input('digite o que mas voce gosta de fazer ')

print(f'Ola meu nome é {nome} muito prazer , eu tenho {idade} anos, moro em  {cidade}   sou {profissao} e gosto muito de {hobby}')